                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/print?order={{ $order->order_code }}" target="_blank">
                                                    <button class="btn btn-success btn-xs" type="button">Cetak</button>
                                                </a>
                                                @else
                                                ...
                                                <button class="btn btn-warning btn-xs position-relative" type="button"
                                                    data-toggle="modal" data-target="#modal-lapor-{{ $order->id }}"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body d-flex flex-column">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <label class="my-1">{{ $complaint->user->name
                                                                        }}</label>
                                                                </div>
