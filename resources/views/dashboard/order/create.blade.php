...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/dashboard" class="brand-link">
            ...
            <span class="brand-text font-weight-light">TicBus</span>
        </a>
                        ...
                        <div class="card card-warning">
                            ...
                            <form action="/orders" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="airline_id" class="col-sm-2 col-form-label">Bus :</label>
                                        <div class="col-sm-5">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <select name="type_id" class="form-control" id="airline_class" required>
                                                    ...
                                                    @else
                                                    <option selected value="">-- Pilih Tipe Bus --
                                                    </option>
                                                    @endif
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" id="pergi-check" type="radio"
                                                        name="round_trip" @if (old('round_trip')==true) @else checked
                                                        @endif value="false">
                                        ...
                                        <div class="col-sm-2">
                                            <!-- <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" id="pergi-pulang-check" type="radio"
                                                        name="round_trip" value="true" @if (old('round_trip')==true)
                                                        checked @else @endif>
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" id="jumlah-penumpang" name="amount">
                                                @for ($i = 1; $i <= 5; $i++) @if ($i==old('amount')) <option value={{ $i
                                                    }} selected>{{ $i }}
                                                    </option>
                                                    @else
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="date" class="form-control pulang-toogle" id="tanggalpulang"
                                                    min="<?php echo date('Y-m-d'); ?>" placeholder="hh/bb/tttt"
                                                    name="return_date">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row pulang-toogle">
                                        <div class="col-lg-2 col-sm-12 align-items-start mb-2">
                                            <button type="button" class="btn btn-primary" id="checkTicketButton2">Cek
                                                Harga
                                                Tiket Pulang</button>
                                        </div>
                                        <div class="col-lg-4 col-sm-12">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <input type="text"
                                                    ...
                                                    id="inputEmail3" placeholder="Nama" name="nama_penumpang_1" required
                                                    value="{{ old('nama_penumpang_1') }}">
